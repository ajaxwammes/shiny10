...
ui <- fluidPage( 
  tags$head(includeHTML("google-analytics.html")),
    ...
    HTML('<title> Travel advice during COVID-19. Insight into global travel restrictions. </title>'),
    theme = shinytheme("spacelab"),
        tabsetPanel(type = "tabs",
                                 ...
                                 column(12,
                                        fluidRow(
                                          column(2, wellPanel(
                                            ...
                                            br(),
                                            br(),
                                            a("Need help with planning your trip?", href="https://anywhr-affiliate.peachs.co/a/covidtravel", target="_blank")
                                            )),
                                 ...
                                 column(12,
                                        fluidRow(
                                          column(2, wellPanel(
                                                     ...
                                                     br(),
                                                     br(),
                                                     HTML("<b> Step 2:</b> See where you are allowed to travel, by standard visa regulations"),
                                                     br(),
                                                     br(),
                                                     br(),
                                                     HTML("<b> Note: As a result of COVID-19, some visa on arrivals and visa-free have been suspended </b>"),
                                                     br())),
                    ...
                    tabPanel("Essential Movement",
                             ...
                             br(),
                             br(),
                             HTML("<b> Always read the the source info before travelling (find the source information by clicking on a country)</b>"),
                             br(),
                             br(),
