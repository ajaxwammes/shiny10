...
data<-read.csv("Data_april_30.csv")
...
ui <- fluidPage(theme = shinytheme("spacelab"),
                ...
                tabPanel("About",
                        ...
                        "CovidTravel is daily updated by data scraping from the most reliable official governmental websites and emabassies 
                        all around the world. The source of data for a specific cuntry can be found by clicking on the country in the tab 'World Map'
                        ...
                        "> Standard visa regulations",
                        br(),
                        "> Availaility of transportation (flights, trains, etc)",
                        br(),
                        "> Essential movements (diplomacy, humantarian, returning home, transits, working, education and more)",
                        br(),
                        "> All forms of transporation (in certain cases a country can not be entered by land, but only by air)",
                        br(),
                        ...
                        "CovidTravel is made and maintained by a team of data engerieers from the National University of Singapore.", 
                        "CovidTravel and its intellectual proporty shall not be used without permission by any third 
