                                 ...
                                 column(12,
                                        fluidRow(
                                          ...
                                          fluidRow(
                                            ...
                                            column(1, 
                                                   a(img(src="Anywhr.png"), href="https://anywhr-affiliate.peachs.co/a/covidtravel", target="_blank"))
                                          )))))),
                                 ...
                                 column(12,
                                        fluidRow(
                                          ...
                                          fluidRow(
                                            ...
                                            column(1, 
                                                   a(img(src="Anywhr.png"), href="https://anywhr.co", target="_blank"))
                                          )))))),
