...
visa2 <- reshape2::dcast(
    dplyr::mutate(
        ...
        value=plyr::mapvalues(
            ...
            c("Visa-Required","Visa-on-Arrival / eVisa","ETA Required","Visa Free 7 Days","Visa Free 14 Days","Visa Free 15 Days", 
...
pal2 <- colorFactor(palette = c("#ff8c00","#ff8c00","#ffffff","#f7f716","#e60000","#129670","#129671","#129672",
...
server <- function(input, output) {
    ...
    output$mymap2 <- renderLeaflet({
        ...
        leaflet(data=map2) %>% addTiles() %>%
            setView(lng=visa5$Longitude[1], lat=visa5$Latitude[1], zoom=3) %>%
